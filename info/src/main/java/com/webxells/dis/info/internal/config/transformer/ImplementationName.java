...
public class ImplementationName extends SinglePart<Implementation> {

    public ImplementationName(final RootConfiguration.Configuration inputReference) {
        super(inputReference);
    }
