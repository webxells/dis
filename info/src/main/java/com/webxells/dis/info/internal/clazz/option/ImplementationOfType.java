...
public class ImplementationOfType extends SinglePart<ImplementationOf> {
    public ImplementationOfType(final RootConfiguration.Configuration configuration) {
        super(configuration);
    }

    @Override
    protected String getValue(final ImplementationOf current) {
