...
public class EnumDescription extends SinglePart<Field> {
    public EnumDescription(final RootConfiguration.Configuration configuration) {
        super(configuration);
    }

    @Override
    protected String getValue(final Field current) {
        return Annotation.extract(Description.class, current)
