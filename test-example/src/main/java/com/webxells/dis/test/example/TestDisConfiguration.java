...
public class TestDisConfiguration implements DisConfig {
    private long monitoringInterval;
    private List<JobConfig> jobConfigs;
    private SystemSupplier<? extends DisSystem> supplier;
