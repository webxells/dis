...
public abstract class JobEvent implements Event {
    private final ServiceJob serviceJob;

    protected JobEvent(final ServiceJob serviceJob) {
    ...
    public String toString() {
        return String.format("%s: {%s}", this.getClass().getName(), ConfigurationMapping.getFormatedLocation(serviceJob));
    }
}