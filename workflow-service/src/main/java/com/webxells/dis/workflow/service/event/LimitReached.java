...
public class LimitReached extends JobEvent {
    private final long limitDatasets;

    public LimitReached(final ServiceJob serviceJob, final long limitDatasets) {
        super(serviceJob);
        this.limitDatasets = limitDatasets;
    }

    public long getLimitDatasets() {
        return limitDatasets;
    }
}