...
@Description("Just an always failing manipulator...")
public class Fail implements SingleCallForAllValuesManipulator {

    @Override
    public void manipulate(final DatasetPiece currentPiece, final MappingPart mappingPart) throws InvalidDatasetException {
        throw new InvalidDatasetException("This happens on purpose!");
    }
}