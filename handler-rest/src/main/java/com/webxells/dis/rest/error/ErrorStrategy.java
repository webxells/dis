...
public interface ErrorStrategy extends ConfigurableByType {
    Response executeRest(Client client, Request request) throws IOException, InterruptedException;

    void executeAsyncRest(Client client, Request request) throws IOException;
}