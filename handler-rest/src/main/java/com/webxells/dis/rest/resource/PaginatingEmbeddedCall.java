...
@Description("Like PaginatingCall but uses an embedded Rest call")
public class PaginatingEmbeddedCall implements MultiResource {
    private Rest call;
    private int round;
    ...
    public void validate() throws InvalidApi {
        if (null == call) {
            throw new InvalidApi("embedded call required");
        }
    }
    ...
    private void setRound(final int current) {
        round = current;
        Optional.ofNullable(call.getRequestContentStrategy())
    ...
    public void setCall(final Rest call) {
        this.call = call;
    }
}