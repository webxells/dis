...
@Description("Writes Output result to request body")
public class DatasetToBody extends DatasetTo {
    @Override
    public void parseInputRequest(final HttpMethod method, final Request.Builder builder,
                                  final RestConfig restConfig) {
        builder.setBodyPublisher(BodyPublisherOfInputStream.byString(getGeneratedOutput()));
    }
