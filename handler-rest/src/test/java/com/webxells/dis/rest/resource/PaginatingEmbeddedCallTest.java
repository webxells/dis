...
class PaginatingEmbeddedCallTest extends MockServerTestCase {

    @Test
    void test() throws InputOutputError, InterruptedException {
        PaginatingEmbeddedCall fixture = new PaginatingEmbeddedCall();
        ...
        Call embedded = new Call();
        embedded.setConfiguration(config);
        embedded.setResponseContentStrategy(new Body());
        embedded.setRequestContentStrategy(List.of(new NumericParameters() {{
