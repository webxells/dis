...
class DayOfMonthTest extends SimpleTestCase {

    @Test
    void test() throws InvalidApi {
        DayOfMonth fixture = new DayOfMonth();
        fixture.setValue(32);
