...
public class DisonNullReader implements DisonElementReader {

    protected static DisonElementReader parseStringValue(final String value) {
    ...
    public boolean equals(final Object obj) {
        return obj instanceof DisonNullReader;
    }
}